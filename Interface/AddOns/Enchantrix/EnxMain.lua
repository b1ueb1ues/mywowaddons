--[[
	...
	Revision: $Id: EnxMain.lua 6158 2018-09-09 15:10:05Z none $
...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxMain.lua $", "$Rev: 6158 $")
...
function addonLoaded(hookArgs, event, addOnName)
	...
	Enchantrix.Revision = Enchantrix.Util.GetRevision("$Rev: 6158 $")
