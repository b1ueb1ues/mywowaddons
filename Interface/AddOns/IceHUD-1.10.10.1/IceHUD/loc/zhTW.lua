...
L["1 combo point: yellow, max combo points: red"] = "1 連擊點：黃色，5 連擊點：紅色" -- Needs review
L["1 lacerate: yellow, 5 lacerates: red"] = "1 割裂：黃色，5 割裂：紅色" -- Needs review
L["1 maelstrom: yellow, 5 maelstroms: red"] = "1 氣漩：黃色，5 氣漩：紅色" -- Needs review
L["1 sunder: yellow, 5 sunders: red"] = "1 破甲：黃色，5 破甲：紅色" -- Needs review
...
L["Adjusts the size of the aura icon for this bar"] = "調整條列的光環圖示尺寸" -- Needs review
L["Adjust the horizontal position of the aura icon"] = "調整光環圖示的水平位置" -- Needs review
L["Adjust the vertical placement of this bar"] = "調整垂直條列的放置"
L["Adjust the vertical position of the aura icon"] = "調整光環圖示的垂直位置" -- Needs review
L["Advanced Bar Settings"] = "進階條列設定"
L["Aggro Indicator alpha"] = "仇恨指示器不透明度" -- Needs review
L["Aggro indicator alpha (0 is disabled)"] = "仇恨指示器不透明度（0 為禁用）" -- Needs review
L["Alert Party"] = "警報隊伍"
L["Allow click casting"] = "允許點擊施放"
L["Allow click-targeting"] = "允許點擊目標"
L["Allow click-targeting in combat"] = "戰門中允許點擊目標" -- Needs review
L["Allow mouse interaction"] = "允許滑鼠交互"
L["Alpha in combat"] = "戰鬥中不透明度" -- Needs review
L["Alpha OOC and not full"] = "不透明度 OCC 及不充滿" -- Needs review
L["Alpha OOC and Target"] = "不透明度 OOC 及目標" -- Needs review
L["Alpha out of combat"] = "戰鬥外透明度"
L["Also show numeric"] = "同時顯示數字" -- Needs review
L["Always display bar"] = "永遠顯示條列"
L["Always show at 100% alpha"] = "永遠顯示 100% 不透明度" -- Needs review
...
L["Aura icon horizontal offset"] = "光環圖示水平位移" -- Needs review
L["Aura icon scale"] = "光環圖示刻度" -- Needs review
L["Aura icon vertical offset"] = "光環圖示垂直位移" -- Needs review
...
L["Background Alpha"] = "背景不透明度" -- Needs review
...
L["BG Alpha in combat"] = "戰鬥中背景不透明度" -- Needs review
L["BG Alpha OOC and not Full"] = "背景不透明度 OCC 及不充滿" -- Needs review
L["BG Alpha OOC and Target"] = "背景不透明度 OCC 及目標" -- Needs review
L["BG Alpha out of combat"] = "戰鬥外背景不透明度" -- Needs review
...
L["Click to open IceHUD options."] = "點擊開啟 IceHUD 弧形血條選項" -- Needs review
L["Color"] = "顏色"
...
L["Display aura icon"] = "顯示光環圖示" -- Needs review
L["Display mode"] = "顯示模式"
L["Display Mode"] = "顯示模式"
...
L["Enable/disable IceHUD"] = "啟用/停用 IceHUD 弧形血條" -- Needs review
...
Remember to press ENTER after filling out this box with the name you want or it will not save.]=] -- Requires localization
L["Error: IceHUD database not loaded correctly.  Please exit out of WoW and delete the database file (IceHUD.lua) found in: \\World of Warcraft\\WTF\\Account\\<Account Name>>\\SavedVariables\\"] = "錯誤: IceHUD 弧形血條資料庫未正確載入。請退出 WOW 然後刪除資料庫檔案 (IceHUD.lua)，位置在: \\World of Warcraft\\WTF\\帳號\\<<帳號名稱>>\\SavedVariables\\" -- Needs review
...
L["Hide during pet battles"] = "寵物戰鬥期間隱藏" -- Needs review
...
L["HUD scale"] = "HUD 刻度"
L["IceHUD"] = "IceHUD 弧形血條" -- Needs review
L["IceHUD Bar Background Blend mode"] = "IceHUD 弧形血條背景混合模式" -- Needs review
L["IceHUD Bar Blend mode"] = "IceHUD 弧形血條混合模式" -- Needs review
L["IceHUD Bar Texture"] = "IceHUD 弧形血條材質" -- Needs review
L["IceHUD Font"] = "IceHUD 弧形血條字型" -- Needs review
...
L["Imports a profile as exported from another user's IceHUD."] = "匯入由其它玩家所匯出的 IceHUD 弧形血條設定檔。" -- Needs review
...
L["No decoration"] = "無裝飾" -- Needs review
...
L["Numeric vertical offset"] = "數字垂直偏移" -- Needs review
L["Offset"] = "位移"
...
L["Only show with a target selected"] = "僅在點選一個目標時顯示" -- Needs review
L["Only track auras by me"] = "只有追蹤光環由我"
L["Other"] = "其他"
L["Outline"] = "描線" -- Needs review
...
L["Show tooltip"] = "顯示工具提示" -- Needs review
...
L["Sunder gap"] = "破甲間隙"
L["Text appearance"] = "文字外觀" -- Needs review
...
Remember to press ENTER/Accept after filling out this box or it will not save.]=] -- Requires localization
L["Thick outline"] = "粗線" -- Needs review
...
(e.g. if the min color is yellow, the color is red, and there are 3 total applications, then the first would be yellow, second orange, and third red)]=] -- Requires localization
L["This will hide the entire mod during pet battles."] = "在寵物戰鬥期間，將隱藏整個模型。" -- Needs review
...
L["Whether or not to show an IceHUD icon on the minimap."] = "無論是不是顯示在小地圖的 IceHUD 弧形血條" -- Needs review
...
L["Whether we are tracking a buff or debuff"] = "無論我們追蹤增益或減益" -- Needs review
