...
L["1 combo point: yellow, max combo points: red"] = "1 point de combo: jaune, 5 points de combo: rouge" -- Needs review
...
L["Adjusts the size of the aura icon for this bar"] = "Ajuster la taille de l'icône de l'aura pour cette barre" -- Needs review
L["Adjust the horizontal position of the aura icon"] = "Ajuster le positionnement horizontale de l'icône de l'aura " -- Needs review
L["Adjust the vertical placement of this bar"] = "Ajuster le positionnement vertical de cette barre"
L["Adjust the vertical position of the aura icon"] = "Ajuster le positionnement vertical de l'icône de l'aura" -- Needs review
...
L["Always show at 100% alpha"] = "Toujours afficher sans transparence" -- Needs review
L["Animate changes"] = "Change l'animation"
L["Animation Duration"] = "Durée de l'animation"
L["Animation Settings"] = "Paramètres de l'animation"
...
L["Aura icon horizontal offset"] = "Décalage horizontal de l'icône" -- Needs review
L["Aura icon scale"] = "Échelle de l'icône" -- Needs review
L["Aura icon vertical offset"] = "Décalage vertical de l'icône" -- Needs review
L["Aura settings"] = "Paramètres des auras" -- Needs review
L["Aura to track"] = "Auras à surveiller" -- Needs review
L["Automatically size this module to the addon's 'gap' setting"] = "Redimensionne automatiquement ce module suivant les paramètres de l'addon" -- Needs review
L["Background Alpha"] = "Transparence de l'arrière-plan"
L["Background alpha for bars IC"] = "Transparence de l'arrière-plan pour les barres \"IC\"" -- Needs review
...
L["BG Alpha OOC and not Full"] = "Transparence de l'arrière-plan hors-combat et vide" -- Needs review
L["BG Alpha OOC and Target"] = "Transparence de l'arrière-plan hors-combat et de la cible" -- Needs review
