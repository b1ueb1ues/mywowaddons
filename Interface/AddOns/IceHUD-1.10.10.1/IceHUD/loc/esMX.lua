...
L["1 combo point: yellow, max combo points: red"] = "1 combo point: yellow, max combo points: red" -- Requires localization
...
L["Adjusts the size of the aura icon for this bar"] = "Adjusts the size of the icon for this bar" -- Requires localization
L["Adjust the horizontal position of the aura icon"] = "Adjust the horizontal position of the icon" -- Requires localization
L["Adjust the vertical placement of this bar"] = "Adjust the vertical placement of this bar" -- Requires localization
L["Adjust the vertical position of the aura icon"] = "Adjust the vertical position of the icon" -- Requires localization
L["Advanced Bar Settings"] = "Advanced Bar Settings" -- Requires localization
L["Aggro Indicator alpha"] = "Aggro Indicator alpha" -- Requires localization
L["Aggro indicator alpha (0 is disabled)"] = "Aggro indicator alpha (0 is disabled)" -- Requires localization
L["Alert Party"] = "Alert Party" -- Requires localization
L["Allow click casting"] = "Allow click casting" -- Requires localization
L["Allow click-targeting"] = "Allow click-targeting" -- Requires localization
L["Allow click-targeting in combat"] = "Allow click-targeting in combat" -- Requires localization
...
L["Aura settings"] = "Aura settings" -- Requires localization
L["Aura to track"] = "Aura to track" -- Requires localization
...
L["Bar alpha In Combat"] = "Bar alpha In Combat" -- Requires localization
...
L["Bar Font Bold"] = "Bar Font Bold" -- Requires localization
...
L["Bar Space"] = "Bar Space" -- Requires localization
...
L["Bar vertical offset"] = "Bar vertical offset" -- Requires localization
L["Bar visible"] = "Bar visible" -- Requires localization
...
L["Buff/debuff icon size"] = "Buff/debuff icon size" -- Requires localization
L["Buff/debuff icon zoom"] = "Buff/debuff icon zoom" -- Requires localization
L["Buff/Debuff Settings"] = "Buff/Debuff Settings" -- Requires localization
...
L["Buff Settings"] = "Buff Settings" -- Requires localization
...
L["Buff vertical offset"] = "Buff vertical offset" -- Requires localization
L["Buff zoom"] = "Buff zoom" -- Requires localization
...
L["Change color"] = "Change color" -- Requires localization
L["Change color when not in range"] = "Change color when not in range" -- Requires localization
...
L["Configuration Mode"] = "Configuration Mode" -- Requires localization
...
L["Cooldown timer display"] = "Cooldown timer display" -- Requires localization
...
L["Create custom module"] = "Create custom module" -- Requires localization
...
L["Debuff anchor to"] = "Debuff anchor to" -- Requires localization
L["Debuff grow direction"] = "Debuff grow direction" -- Requires localization
L["Debuff horizontal offset"] = "Debuff horizontal offset" -- Requires localization
L["Debuff placement settings"] = "Debuff placement settings" -- Requires localization
L["Debuff Settings"] = "Debuff Settings" -- Requires localization
L["Debuff size"] = "Debuff size" -- Requires localization
L["Debuff vertical offset"] = "Debuff vertical offset" -- Requires localization
L["(De)Buff watcher"] = "(De)Buff watcher" -- Requires localization
L["Debugging"] = "Debugging" -- Requires localization
...
L["Delete me"] = "Delete me" -- Requires localization
...
L["Display when targeting"] = "Display when targeting" -- Requires localization
...
L["Enable/disable debug messages"] = "Enable/disable debug messages" -- Requires localization
L["Enable/disable IceHUD"] = "Enable/disable IceHUD" -- Requires localization
L["Enable/disable module"] = "Enable/disable module" -- Requires localization
...
L["Gap"] = "Gap" -- Requires localization
L["General Settings"] = "General Settings" -- Requires localization
L["Height"] = "Height" -- Requires localization
L["Hide Blizzard Buffs"] = "Hide Blizzard Buffs" -- Requires localization
L["Hide Blizzard Frame"] = "Hide Blizzard Frame" -- Requires localization
L["Hide Blizzard Party"] = "Hide Blizzard Party" -- Requires localization
...
L["IceHUD"] = "IceHUD" -- Requires localization
...
L["IceHUD Bar Texture"] = "IceHUD Bar Texture" -- Requires localization
L["IceHUD Font"] = "IceHUD Font" -- Requires localization
...
L["Icon Settings"] = "Icon Settings" -- Requires localization
...
L["Import profile"] = "Import profile" -- Requires localization
...
L["Inactive mode"] = "Inactive mode" -- Requires localization
...
L["Lacerate gap"] = "Lacerate gap" -- Requires localization
L["Lag Indicator alpha"] = "Lag Indicator alpha" -- Requires localization
...
L["Left Tag"] = "Left Tag" -- Requires localization
L["Line 1 tag"] = "Line 1 tag" -- Requires localization
L["Line 2 tag"] = "Line 2 tag" -- Requires localization
L["Line 3 tag"] = "Line 3 tag" -- Requires localization
L["Line 4 tag"] = "Line 4 tag" -- Requires localization
L["Lock all icons to 100% alpha"] = "Lock all icons to 100% alpha" -- Requires localization
L["Lock Bar Text Alpha"] = "Lock Bar Text Alpha" -- Requires localization
L["Lock Lower Text Alpha"] = "Lock Lower Text Alpha" -- Requires localization
L["Lock raid icon to 100% alpha"] = "Lock raid icon to 100% alpha" -- Requires localization
...
L["Lock Upper Text Alpha"] = "Lock Upper Text Alpha" -- Requires localization
...
L["Module type:"] = "Module type:" -- Requires localization
...
L["Only show buffs by me"] = "Only show buffs by me" -- Requires localization
L["Only show debuffs by me"] = "Only show debuffs by me" -- Requires localization
L["Only show for my debuffs"] = "Only show for my debuffs" -- Requires localization
L["Only show if target uses mana"] = "Only show if target uses mana" -- Requires localization
...
L["Only track auras by me"] = "Only track auras by me" -- Requires localization
...
L["Own buff size"] = "Own buff size" -- Requires localization
L["Own debuff size"] = "Own debuff size" -- Requires localization
...
L["Position (percent)"] = "Position (percent)" -- Requires localization
...
L["PvP icon"] = "PvP icon" -- Requires localization
L["PvP Icon Horizontal Offset"] = "PvP Icon Horizontal Offset" -- Requires localization
L["PvP Icon Scale"] = "PvP Icon Scale" -- Requires localization
L["PvP Icon Vertical Offset"] = "PvP Icon Vertical Offset" -- Requires localization
L["Raid icon"] = "Raid icon" -- Requires localization
L["Raid Icon Scale"] = "Raid Icon Scale" -- Requires localization
L["Raid Icon X Offset"] = "Raid Icon X Offset" -- Requires localization
L["Raid Icon Y Offset"] = "Raid Icon Y Offset" -- Requires localization
...
L["Reverse direction"] = "Reverse direction" -- Requires localization
L["Right Tag"] = "Right Tag" -- Requires localization
L["Rotate 90 degrees"] = "Rotate 90 degrees" -- Requires localization
L["Rune cooldown mode"] = "Rune cooldown mode" -- Requires localization
L["Rune display mode"] = "Rune display mode" -- Requires localization
L["Rune gap"] = "Rune gap" -- Requires localization
...
L["Sets the height of this module."] = "Sets the height of this module." -- Requires localization
...
L["Show debuffs"] = "Show debuffs" -- Requires localization
L["Show default cast bar"] = "Show default cast bar" -- Requires localization
L["Show during cast"] = "Show during cast" -- Requires localization
L["Show Elite Icon"] = "Show Elite Icon" -- Requires localization
L["Show graphical or numeric combo points"] = "Show graphical or numeric combo points" -- Requires localization
L["Show graphical or numeric counts"] = "Show graphical or numeric counts" -- Requires localization
L["Show graphical or numeric lacerates"] = "Show graphical or numeric lacerates" -- Requires localization
L["Show graphical or numeric maelstroms"] = "Show graphical or numeric maelstroms" -- Requires localization
L["Show graphical or numeric sunders"] = "Show graphical or numeric sunders" -- Requires localization
L["Show incoming heals"] = "Show incoming heals" -- Requires localization
L["Show leader icon"] = "Show leader icon" -- Requires localization
L["Show loot master icon"] = "Show loot master icon" -- Requires localization
...
L["Text Horizontal Offset"] = "Text Horizontal Offset" -- Requires localization
L["Text Settings"] = "Text Settings" -- Requires localization
L["Texture"] = "Texture" -- Requires localization
L["Text Vertical Offset"] = "Text Vertical Offset" -- Requires localization
...
L["The color for this bar"] = "The color for this bar" -- Requires localization
L["The color for this counter"] = "The color for this counter" -- Requires localization
...
L["Totem cooldown mode"] = "Totem cooldown mode" -- Requires localization
L["Totem gap"] = "Totem gap" -- Requires localization
L["Totem orientation"] = "Totem orientation" -- Requires localization
L["ToT frame texture"] = "ToT frame texture" -- Requires localization
L["Transparency Settings"] = "Transparency Settings" -- Requires localization
...
L["Unit to track"] = "Unit to track" -- Requires localization
L["Update"] = "Update" -- Requires localization
L["Update Period"] = "Update Period" -- Requires localization
L["Upper Text"] = "Upper Text" -- Requires localization
L["Upper Text Color"] = "Upper Text Color" -- Requires localization
L["Upper text visible"] = "Upper text visible" -- Requires localization
...
L["Use normal alpha"] = "Use normal alpha" -- Requires localization
...
L["Vertical Position"] = "Vertical Position" -- Requires localization
L["Visibility Settings"] = "Visibility Settings" -- Requires localization
