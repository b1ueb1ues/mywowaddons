...
L["1 combo point: yellow, max combo points: red"] = "연계 점수 1점: 노랑, 연계 점수 5점: 빨강" -- Needs review
L["1 lacerate: yellow, 5 lacerates: red"] = "가르기 1중첩: 노랑, 가르기 5중첩: 빨강" -- Needs review
L["1 maelstrom: yellow, 5 maelstroms: red"] = "소용돌이치는 무기 1중첩: 노랑, 소용돌이치는 무기 5중첩: 빨강" -- Needs review
L["1 sunder: yellow, 5 sunders: red"] = "방어구 가르기 1중첩: 노랑; 방어구 가르기 5중첩: 빨강" -- Needs review
L["Abbreviate estimated health"] = "추정 생명력 간소화" -- Needs review
L["Abbreviate health"] = "생명력 간소화" -- Needs review
L["Absorb bar alpha"] = "Absorb bar alpha" -- Requires localization
...
L["A custom counter bar has been created and can be configured through Module Settings => MyCustomCounterBar. It is highly recommended that you change the bar name of this module so that it's easier to identify."] = "A custom counter bar has been created and can be configured through Module Settings => MyCustomCounterBar. It is highly recommended that you change the bar name of this module so that it's easier to identify." -- Requires localization
...
L["Adjusts the size of the aura icon for this bar"] = "이 바의 오라 아이콘 크기 설정" -- Needs review
L["Adjust the horizontal position of the aura icon"] = "오라 아이콘의 수평 위치 설정" -- Needs review
L["Adjust the vertical placement of this bar"] = "바의 수직 위치 설정" -- Needs review
L["Adjust the vertical position of the aura icon"] = "오라 아이콘의 수직 위치 설정" -- Needs review
L["Advanced Bar Settings"] = "고급 바 설정" -- Needs review
L["Aggro Indicator alpha"] = "알파 위협 수준 표시" -- Needs review
L["Aggro indicator alpha (0 is disabled)"] = "Aggro indicator alpha (0 is disabled)" -- Requires localization
L["Alert Party"] = "파티원에게 알리기" -- Needs review
L["Allow click casting"] = "클릭 시전 허용" -- Needs review
L["Allow click-targeting"] = "대상 클릭 허용" -- Needs review
L["Allow click-targeting in combat"] = "전투 중 대상 클릭 허용" -- Needs review
L["Allow mouse interaction"] = "마우스 상호작용 허용" -- Needs review
L["Alpha in combat"] = "전투 중 알파" -- Needs review
...
L["Alpha out of combat"] = "비전투 중 알파" -- Needs review
L["Also show numeric"] = "Also show numeric" -- Requires localization
L["Always display bar"] = "바 항상 보이기" -- Needs review
L["Always show at 100% alpha"] = "항상 100% 알파로 보기" -- Needs review
L["Animate changes"] = "Animate changes" -- Requires localization
L["Animation Duration"] = "Animation Duration" -- Requires localization
L["Animation Settings"] = "Animation Settings" -- Requires localization
L["Answers to questions that are frequently asked."] = "Answers to questions that are frequently asked." -- Requires localization
...
L["Aura icon horizontal offset"] = "Icon horizontal offset" -- Requires localization
L["Aura icon scale"] = "Icon scale" -- Requires localization
L["Aura icon vertical offset"] = "Icon vertical offset" -- Requires localization
L["Aura settings"] = "오라 설정" -- Needs review
L["Aura to track"] = "추적할 오라" -- Needs review
L["Automatically size this module to the addon's 'gap' setting"] = "Automatically size this module to the addon's 'gap' setting" -- Requires localization
L["Background Alpha"] = "배경 알파" -- Needs review
...
L["Background alpha for bars OOC without target"] = "Background alpha for bars OOC without target" -- Requires localization
L["Background Color"] = "배경 색상" -- Needs review
L["Bar Alpha"] = "Bar Alpha" -- Requires localization
L["Bar alpha In Combat"] = "전투 중 바 알파" -- Needs review
L["Bar alpha Out Of Combat without target"] = "Bar alpha Out Of Combat without target" -- Requires localization
...
L["Bar background visible"] = "바 배경 보이기" -- Needs review
L["Bar Blend Mode"] = "Bar Blend Mode" -- Requires localization
L["Bar color"] = "바 색상" -- Needs review
L["Bar Font Bold"] = "바 글꼴 굵게" -- Needs review
L["Bar Font Size"] = "바 글꼴 크기" -- Needs review
L["Bar Height"] = "바 높이" -- Needs review
L["Bar horizontal adjust"] = "바 수평 설정" -- Needs review
L["Bar name"] = "바 이름" -- Needs review
L["Bar Proportion"] = "바 비율" -- Needs review
L["Bar Settings"] = "바 설정" -- Needs review
L["Bar Space"] = "바 간격" -- Needs review
L["Bar Texture"] = "Bar Texture" -- Requires localization
L["Bar texture height (not the actual bar!)"] = "Bar texture height (not the actual bar!)" -- Requires localization
L["Bar Texture Override"] = "Bar Texture Override" -- Requires localization
L["Bar texture width (not the actual bar!)"] = "Bar texture width (not the actual bar!)" -- Requires localization
L["Bar vertical offset"] = "바 수직 기준" -- Needs review
L["Bar visible"] = "바 보이기" -- Needs review
L["Bar Width"] = "바 너비" -- Needs review
L["Bar width modifier"] = "Bar width modifier" -- Requires localization
...
L["BG Alpha OOC and Target"] = "BG Alpha OOC and Target" -- Requires localization
...
L["Buff anchor to"] = "Buff anchor to" -- Requires localization
L["Buff/debuff icon size"] = "버프/디버프 아이콘 크기" -- Needs review
L["Buff/debuff icon zoom"] = "버프/디버프 아이콘 확대" -- Needs review
L["Buff/Debuff Settings"] = "버프/디버프 설정" -- Needs review
...
L["Buff grow direction"] = "Buff grow direction" -- Requires localization
L["Buff horizontal offset"] = "Buff horizontal offset" -- Requires localization
L["Buff or debuff?"] = "Buff or debuff?" -- Requires localization
L["Buff placement settings"] = "Buff placement settings" -- Requires localization
L["Buff Settings"] = "버프 설정" -- Needs review
L["Buff size"] = "Buff size" -- Requires localization
L["Buffs / row"] = "Buffs / row" -- Requires localization
L["Buff timer display"] = "Buff timer display" -- Requires localization
L["Buff vertical offset"] = "버프 수직 기준" -- Needs review
L["Buff zoom"] = "버프 확대" -- Needs review
L["Cannot report AFK from addons"] = "Cannot report AFK from addons" -- Requires localization
L["|cff8888ffIceHUD|r: Combat lockdown restriction. Leave combat and try again."] = "|cff8888ffIceHUD|r: Combat lockdown restriction. Leave combat and try again." -- Requires localization
L["Change color"] = "색상 변경" -- Needs review
L["Change color when not in range"] = "유효 거리 밖일 때 색상 변경" -- Needs review
...
L["Class color bar"] = "Class color bar" -- Requires localization
L["Classification icon"] = "Classification icon" -- Requires localization
...
L["Click to open IceHUD options."] = "Click to open IceHUD options." -- Requires localization
L["Color"] = "Color" -- Requires localization
L["Color bar by health %"] = "Color bar by health %" -- Requires localization
L["Color bar by mana %"] = "Color bar by mana %" -- Requires localization
L["Color NPC by hostility"] = "Color NPC by hostility" -- Requires localization
L["Colors"] = "Colors" -- Requires localization
L["Colors the health bar from MaxHealthColor to MinHealthColor based on current health %"] = "Colors the health bar from MaxHealthColor to MinHealthColor based on current health %" -- Requires localization
...
L["Combo gap"] = "Combo gap" -- Requires localization
L["Combo Points Font Size"] = "Combo Points Font Size" -- Requires localization
L["Configuration Mode"] = "환경 설정" -- Needs review
L["Contextual Background"] = "Contextual Background" -- Requires localization
...
L["Cooldown timer display"] = "재사용 대기시간 보이기" -- Needs review
L["Cooldown type"] = "Cooldown type" -- Requires localization
L["Count color"] = "Count color" -- Requires localization
L["Counter"] = "Counter" -- Requires localization
L["CounterBar"] = "CounterBar" -- Requires localization
L["Counter look and feel"] = "Counter look and feel" -- Requires localization
L["Counter name"] = "Counter name" -- Requires localization
L["Count minimum color"] = "Count minimum color" -- Requires localization
L["Create"] = "만들기" -- Needs review
L["Create custom module"] = "사용자 설정 모듈 만들기" -- Needs review
L["Create marker"] = "Create marker" -- Requires localization
...
L["Creates the selected custom module"] = "Creates the selected custom module" -- Requires localization
L["Custom bar settings"] = "Custom bar settings" -- Requires localization
L["Custom CD settings"] = "Custom CD settings" -- Requires localization
L["Custom color"] = "Custom color" -- Requires localization
L["Custom minimum color"] = "Custom minimum color" -- Requires localization
L["Custom unit"] = "Custom unit" -- Requires localization
L["Debuff anchor to"] = "디버프 기준점" -- Needs review
L["Debuff grow direction"] = "디버프 창 확장 방향" -- Needs review
L["Debuff horizontal offset"] = "디버프 수평 기준" -- Needs review
L["Debuff placement settings"] = "Debuff placement settings" -- Requires localization
L["Debuff Settings"] = "디버프 설정" -- Needs review
L["Debuff size"] = "디버프 크기" -- Needs review
L["Debuff vertical offset"] = "디버프 수직 기준" -- Needs review
L["(De)Buff watcher"] = "(De)Buff watcher" -- Requires localization
L["Debugging"] = "디버깅" -- Needs review
...
L["Display aura icon"] = "Display icon" -- Requires localization
L["Display mode"] = "Display mode" -- Requires localization
L["Display Mode"] = "Display Mode" -- Requires localization
L["Display non-interruptible color"] = "Display non-interruptible color" -- Requires localization
L["Display target details"] = "Display target details" -- Requires localization
L["Display target guild"] = "Display target guild" -- Requires localization
L["Display target name"] = "Display target name" -- Requires localization
L["Display when empty"] = "Display when empty" -- Requires localization
L["Display when targeting"] = "대상 지정 시 보이기" -- Needs review
...
Remember to press Accept after filling out this box or it will not save.]=] -- Requires localization
L["Draw Elite Icon On Top"] = "Draw Elite Icon On Top" -- Requires localization
L["Draw PVP Icon on top"] = "Draw PVP Icon on top" -- Requires localization
L["Draw Raid Icon On Top"] = "Draw Raid Icon On Top" -- Requires localization
L["Duplicate me"] = "Duplicate me" -- Requires localization
L["Edit Marker"] = "Edit Marker" -- Requires localization
L["Elite Icon Scale"] = "Elite Icon Scale" -- Requires localization
L["Elite Icon X Offset"] = "Elite Icon X Offset" -- Requires localization
L["Elite Icon Y Offset"] = "Elite Icon Y Offset" -- Requires localization
L["Enabled"] = "사용" -- Needs review
L["Enable/disable debug messages"] = "디버깅 메세지 사용/미사용" -- Needs review
L["Enable/disable IceHUD"] = "IceHUD 사용/미사용" -- Needs review
L["Enable/disable module"] = "모듈 사용/미사용" -- Needs review
L["Energy Ticker Alpha"] = "Energy Ticker Alpha" -- Requires localization
...
L["Exact match only"] = "Exact match only" -- Requires localization
L["Export profile"] = "Export profile" -- Requires localization
...
L["FAQs"] = "FAQs" -- Requires localization
L["Flash bar below Low Threshold"] = "Flash bar below Low Threshold" -- Requires localization
...
L["Flash Instant Spells"] = "Flash Instant Spells" -- Requires localization
L["Flash on Spell Failures"] = "Flash on Spell Failures" -- Requires localization
L["Flash when ready"] = "Flash when ready" -- Requires localization
L["Font"] = "폰트" -- Needs review
L["Font Size"] = "폰트 크기" -- Needs review
L["Force Text Justification"] = "Force Text Justification" -- Requires localization
L["Friendly OOC alpha"] = "Friendly OOC alpha" -- Requires localization
L["Gap"] = "간격" -- Needs review
L["General Settings"] = "일반 설정" -- Needs review
L["Height"] = "높이" -- Needs review
L["Hide Blizzard Buffs"] = "기본 인터페이스 버프 숨기기" -- Needs review
L["Hide Blizzard Frame"] = "기본 인터페이스 프레임 숨기기" -- Needs review
L["Hide Blizzard Party"] = "기본 인터페이스 파티창 숨기기" -- Needs review
L["Hide during pet battles"] = "Hide during pet battles" -- Requires localization
L["Hide in barbershops"] = "Hide in barbershops" -- Requires localization
...
NOTE: Blizzard attaches the arcane charges UI to the player's unitframe, so if you have that hidden in PlayerHealth, then this won't do anything.]=] -- Requires localization
...
L["Horizontal position"] = "수평 위치" -- Needs review
L["Horizontal Position"] = "수평 위치" -- Needs review
L["Horizontal position (for you dual screen freaks)"] = "Horizontal position (for you dual screen freaks)" -- Requires localization
...
L["How far to push the elite icon right or left"] = "How far to push the elite icon right or left" -- Requires localization
L["How far to push the elite icon up or down"] = "How far to push the elite icon up or down" -- Requires localization
L["How far to push the raid icon right or left"] = "How far to push the raid icon right or left" -- Requires localization
L["How far to push the raid icon up or down"] = "How far to push the raid icon up or down" -- Requires localization
...
L["How much to scale the elite icon"] = "How much to scale the elite icon" -- Requires localization
L["How much to scale the leader icon"] = "How much to scale the leader icon" -- Requires localization
L["How much to scale the loot master icon"] = "How much to scale the loot master icon" -- Requires localization
L["How much to scale the Party Role icon"] = "How much to scale the Party Role icon" -- Requires localization
L["How much to scale the PvP icon"] = "How much to scale the PvP icon" -- Requires localization
L["How much to scale the raid icon"] = "How much to scale the raid icon" -- Requires localization
L["How much to scale the status icon"] = "How much to scale the status icon" -- Requires localization
...
L["HUD scale"] = "HUD scale" -- Requires localization
L["IceHUD"] = "IceHUD" -- Needs review
L["IceHUD Bar Background Blend mode"] = "IceHUD Bar Background Blend mode" -- Requires localization
L["IceHUD Bar Blend mode"] = "IceHUD Bar Blend mode" -- Requires localization
L["IceHUD Bar Texture"] = "IceHUD 바 질감" -- Needs review
L["IceHUD Font"] = "IceHUD 폰트" -- Needs review
L["Icon config mode"] = "Icon config mode" -- Requires localization
L["Icon gap"] = "Icon gap" -- Requires localization
L["Icon set"] = "Icon set" -- Requires localization
L["Icon Settings"] = "아이콘 설정" -- Needs review
L["Icon size"] = "아이콘 크기" -- Needs review
L["Icon size for auras that were applied by you, the player"] = "본인이 사용한 오라의 아이콘 크기 설정" -- Needs review
...
L["If this is checked, then the bar uses different colors depending on how many RtB buffs you have"] = "If this is checked, then the bar uses different colors depending on how many RtB buffs you have" -- Requires localization
...
L["If this is checked, then the RtB buff time shows as a percent of the maximum attainable (taking set bonuses and talents into account). Otherwise, the bar always goes from full to empty when applying RtB no matter the duration."] = "If this is checked, then the RtB buff time shows as a percent of the maximum attainable (taking set bonuses and talents into account). Otherwise, the bar always goes from full to empty when applying RtB no matter the duration." -- Requires localization
...
L["Ignore range"] = "Ignore range" -- Requires localization
L["Import profile"] = "프로필 가져오기" -- Needs review
...
L["Inactive mode"] = "비활성화 모드" -- Needs review
L["Incoming heal bar alpha"] = "Incoming heal bar alpha" -- Requires localization
L["Invert bar"] = "Invert bar" -- Requires localization
L["Item to track"] = "Item to track" -- Requires localization
L["Lacerate Count Font Size"] = "Lacerate Count Font Size" -- Requires localization
L["Lacerate gap"] = "가르기 간격" -- Needs review
L["Lag Indicator alpha"] = "렉 표시 알파" -- Needs review
L["Lag indicator alpha (0 is disabled)"] = "Lag indicator alpha (0 is disabled)" -- Requires localization
L["Layout"] = "레이아웃" -- Needs review
L["Leader icon"] = "Leader icon" -- Requires localization
L["Leader Icon Horizontal Offset"] = "Leader Icon Horizontal Offset" -- Requires localization
L["Leader Icon Scale"] = "Leader Icon Scale" -- Requires localization
L["Leader Icon Vertical Offset"] = "Leader Icon Vertical Offset" -- Requires localization
L["Left Tag"] = "왼쪽 태그" -- Needs review
L["Line 1 tag"] = "첫번째 줄 태그" -- Needs review
L["Line 2 tag"] = "두번째 줄 태그" -- Needs review
L["Line 3 tag"] = "세번쨰 줄 태그" -- Needs review
L["Line 4 tag"] = "네번째 줄 태그" -- Needs review
L["Lock all icons to 100% alpha"] = "모든 아이콘을 100% 알파로 잠금" -- Needs review
L["Lock Bar Text Alpha"] = "문자 알파 바 잠금" -- Needs review
L["Lock Lower Text Alpha"] = "하단 문자 알파 잠금" -- Needs review
L["Lock raid icon to 100% alpha"] = "공격대 아이콘을 100% 알파로 잠금" -- Needs review
L["Locks lower text alpha to 100%"] = "Locks lower text alpha to 100%" -- Requires localization
L["Locks text alpha to 100%"] = "Locks text alpha to 100%" -- Requires localization
L["Locks upper text alpha to 100%"] = "Locks upper text alpha to 100%" -- Requires localization
L["Lock Upper Text Alpha"] = "상단 문자 알파 잠금" -- Needs review
L["Look and Feel"] = "Look and Feel" -- Requires localization
L["Loot Master icon"] = "Loot Master icon" -- Requires localization
L["Loot Master Icon Horizontal Offset"] = "Loot Master Icon Horizontal Offset" -- Requires localization
L["Loot Master Icon Scale"] = "Loot Master Icon Scale" -- Requires localization
L["Loot Master Icon Vertical Offset"] = "Loot Master Icon Vertical Offset" -- Requires localization
L["Lower Text"] = "Lower Text" -- Requires localization
L["Lower Text Color"] = "Lower Text Color" -- Requires localization
L["Lower text visible"] = "Lower text visible" -- Requires localization
L["Low Threshold"] = "Low Threshold" -- Requires localization
L["Low Threshold color"] = "Low Threshold color" -- Requires localization
L["Maelstrom Count Font Size"] = "Maelstrom Count Font Size" -- Requires localization
L["Maelstrom gap"] = "Maelstrom gap" -- Requires localization
...
L["Marker Settings"] = "Marker Settings" -- Requires localization
L["Maximum applications"] = "Maximum applications" -- Requires localization
...
Remember to press ENTER after filling out this box with the name you want or it will not save.]=] -- Requires localization
L["Minimum stacks to show"] = "Minimum stacks to show" -- Requires localization
L["Module color configuration options"] = "Module color configuration options" -- Requires localization
L["Module configuration options"] = "Module configuration options" -- Requires localization
L["Module options"] = "Module options" -- Requires localization
L["Module Settings"] = "Module Settings" -- Requires localization
L["Module type:"] = "모듈 종류" -- Needs review
L["Mouseover"] = "Mouseover" -- Requires localization
L["Mouseover for buffs"] = "Mouseover for buffs" -- Requires localization
L["Mouseover for target"] = "Mouseover for target" -- Requires localization
L["Mouse settings"] = "Mouse settings" -- Requires localization
L["No decoration"] = "No decoration" -- Requires localization
L["Number of updates per second. The higher this number is, the smoother bars will animate. However, higher settings will also use more CPU, so balance it to your liking. 30 is the recommended setting."] = "초당 업데이트 수. 숫자가 높을수록 바가 더 부드럽게 나타나지만, 높은 설정일수록 CPU 소모가 큽니다. 따라서, 적정한 숫자를 설정하십시오. 30은 추천 설정." -- Needs review
L["Numeric vertical offset"] = "Numeric vertical offset" -- Requires localization
L["Offset"] = "Offset" -- Requires localization
L["Offset of the bar"] = "Offset of the bar" -- Requires localization
L["Offset of the text from the bar horizontally"] = "Offset of the text from the bar horizontally" -- Requires localization
...
L["Only show buffs by me"] = "내가 시전한 버프만 보여주기" -- Needs review
L["Only show debuffs by me"] = "내가 시전한 디버프만 보여주기" -- Needs review
L["Only show for my debuffs"] = "나의 디버프만 보여주기" -- Needs review
L["Only show if target uses mana"] = "대상이 마나를 소모할 때만 보여주기" -- Needs review
L["Only show in groups"] = "Only show in groups" -- Requires localization
L["Only show the bar when the number of applications of this buff or debuff exceeds this number"] = "Only show the bar when the number of applications of this buff or debuff meets or exceeds this number" -- Requires localization
...
L["Only track auras by me"] = "내가 사용한 오라만 보이기" -- Needs review
L["Other"] = "기타" -- Needs review
L["Outline"] = "Outline" -- Requires localization
L["Override alpha when not full"] = "Override alpha when not full" -- Requires localization
L["Override global texture"] = "Override global texture" -- Requires localization
L["Own buff size"] = "자신의 버프 크기" -- Needs review
L["Own debuff size"] = "본인의 디버프 크기" -- Needs review
L["Party Role icon"] = "Party Role icon" -- Requires localization
L["Party Role Icon Horizontal Offset"] = "Party Role Icon Horizontal Offset" -- Requires localization
L["Party Role Icon Scale"] = "Party Role Icon Scale" -- Requires localization
L["Party Role Icon Vertical Offset"] = "Party Role Icon Vertical Offset" -- Requires localization
L["Positioning Settings"] = "Positioning Settings" -- Requires localization
L["Position (percent)"] = "위치 (퍼센트)" -- Needs review
L["Potential RtB time bar alpha"] = "Potential RtB time bar alpha" -- Requires localization
L["Potential SnD time bar alpha"] = "Potential SnD time bar alpha" -- Requires localization
L["Predefined settings for different bars"] = "Predefined settings for different bars" -- Requires localization
L["Presets"] = "Presets" -- Requires localization
L["Pulse when full"] = "Pulse when full" -- Requires localization
L["PvP icon"] = "PvP 아이콘" -- Needs review
L["PvP Icon Horizontal Offset"] = "PvP 아이콘 수평 기준" -- Needs review
L["PvP Icon Scale"] = "PvP Icon Scale" -- Requires localization
L["PvP Icon Vertical Offset"] = "PvP 아이콘 수직 기준" -- Needs review
L["Raid icon"] = "공격대 아이콘" -- Needs review
L["Raid Icon Scale"] = "Raid Icon Scale" -- Requires localization
L["Raid Icon X Offset"] = "공격대 아이콘 가로축 기준" -- Needs review
L["Raid Icon Y Offset"] = "공격대 아이콘 세로축 기준" -- Needs review
L["Range string"] = "Range string" -- Requires localization
L["Remove"] = "삭제" -- Needs review
L["Respect lag tolerance"] = "Respect lag tolerance" -- Requires localization
L["Reverse channeling"] = "Reverse channeling" -- Requires localization
L["Reverse direction"] = "반대 방향" -- Needs review
L["Right Tag"] = "우측 태그" -- Needs review
L["Rotate 90 degrees"] = "90도 회전하기" -- Needs review
L["Rune cooldown mode"] = "룬 쿨다운 모드" -- Needs review
L["Rune display mode"] = "Rune display mode" -- Requires localization
L["Rune gap"] = "룬 간격" -- Needs review
L["Rune orientation"] = "Rune orientation" -- Requires localization
L["Scale"] = "Scale" -- Requires localization
L["Scale for non-mana users"] = "Scale for non-mana users" -- Requires localization
L["Scale of the bar"] = "Scale of the bar" -- Requires localization
L["Scale of the element"] = "Scale of the element" -- Requires localization
...
L["Self Color"] = "Self Color" -- Requires localization
L["Self Display Mode"] = "Self Display Mode" -- Requires localization
L["Sets the height of this module."] = "이 모듈의 높이 설정" -- Needs review
...
L["Settings for bar transparencies"] = "Settings for bar transparencies" -- Requires localization
L["Settings related to bars"] = "Settings related to bars" -- Requires localization
L["Settings related to icons"] = "Settings related to icons" -- Requires localization
L["Settings related to positioning and alpha"] = "Settings related to positioning and alpha" -- Requires localization
L["Settings related to texts"] = "Settings related to texts" -- Requires localization
L["Shadow"] = "Shadow" -- Requires localization
L["Show absorbs"] = "Show absorbs" -- Requires localization
...
L["Show buffs"] = "Show buffs" -- Requires localization
L["Show combat status"] = "Show combat status" -- Requires localization
L["Show debuffs"] = "디버프 보이기" -- Needs review
L["Show default cast bar"] = "기본 인터페이스 시전 바 보이기" -- Needs review
L["Show during cast"] = "Show during cast" -- Requires localization
L["Show Elite Icon"] = "Show Elite Icon" -- Requires localization
L["Show graphical or numeric combo points"] = "숫자 또는 그래픽의 연계 점수 보이기" -- Needs review
L["Show graphical or numeric counts"] = "Show graphical or numeric counts" -- Requires localization
L["Show graphical or numeric lacerates"] = "숫자 또는 그래픽의 가르기 보이기" -- Needs review
L["Show graphical or numeric maelstroms"] = "숫자 또는 그래픽의 소용돌이치는 무기 보이기" -- Needs review
L["Show graphical or numeric sunders"] = "숫자 또는 그래픽의 방어구 가르기 보이기" -- Needs review
L["Show incoming heals"] = "받는 치유 보이기" -- Needs review
L["Show leader icon"] = "파티장 또는 공격대장 아이콘 보이기" -- Needs review
L["Show loot master icon"] = "루팅 권한이 있는 사람의 아이콘 보이기" -- Needs review
L["Show Minimap Icon"] = "Show Minimap Icon" -- Requires localization
L["Show Party Role icon"] = "Show Party Role icon" -- Requires localization
L["Show points stored by the Anticipation talent"] = "Show points stored by the Anticipation talent" -- Requires localization
L["Show PvP icon"] = "Show PvP icon" -- Requires localization
L["Show Raid Icon"] = "Show Raid Icon" -- Requires localization
L["Show resting status"] = "Show resting status" -- Requires localization
L["Show rogue/cat energy ticker"] = "Show rogue/cat energy ticker" -- Requires localization
...
L["Show scaled threat"] = "Show scaled threat" -- Requires localization
L["Show second highest threat"] = "Show second highest threat" -- Requires localization
L["Show spell cast time"] = "Show spell cast time" -- Requires localization
L["Show spell rank"] = "Show spell rank" -- Requires localization
...
L["Show the tooltip for this unit when the mouse is hovering over it."] = "마우스오버된 대상의 툴팁 보이기" -- Needs review
L["Show tooltip"] = "툴팁 보이기" -- Needs review
L["Show when not full"] = "Show when not full" -- Requires localization
L["Show with no target"] = "Show with no target" -- Requires localization
...
L["Size and Placement"] = "Size and Placement" -- Requires localization
L["Size to gap"] = "Size to gap" -- Requires localization
L["Sort by expiration"] = "Sort by expiration" -- Requires localization
L["Space between bars on the same side"] = "Space between bars on the same side" -- Requires localization
L["Space between buffs"] = "Space between buffs" -- Requires localization
...
L["Spell cast text visible"] = "Spell cast text visible" -- Requires localization
L["Spell to track"] = "Spell to track" -- Requires localization
L["Stack Font Size"] = "Stack Font Size" -- Requires localization
L["Status icon"] = "Status icon" -- Requires localization
L["Status Icon Horizontal Offset"] = "Status Icon Horizontal Offset" -- Requires localization
L["Status Icon Scale"] = "Status Icon Scale" -- Requires localization
L["Status Icon Vertical Offset"] = "Status Icon Vertical Offset" -- Requires localization
L["Sunder Count Font Size"] = "Sunder Count Font Size" -- Requires localization
L["Sunder gap"] = "Sunder gap" -- Requires localization
L["Text appearance"] = "Text appearance" -- Requires localization
L["Text Horizontal Offset"] = "수평 문자 기준" -- Needs review
L["Text Settings"] = "문자 설정" -- Needs review
L["Texture"] = "질감" -- Needs review
L["Text Vertical Offset"] = "수직 문자 기준" -- Needs review
...
L["The color for this bar"] = "이 바의 색깔" -- Needs review
L["The color for this counter"] = "이 카운터 색상" -- Needs review
L["The color this marker should be."] = "이 표시의 색상" -- Needs review
...
L["The type of thing to track the cooldown of"] = "The type of thing to track the cooldown of" -- Requires localization
...
L["This will hide the entire mod when interacting with a barbershop."] = "This will hide the entire mod when interacting with a barbershop." -- Requires localization
...
L["Toggle bar background visibility"] = "Toggle bar background visibility" -- Requires localization
L["Toggle bar visibility"] = "Toggle bar visibility" -- Requires localization
L["Toggle lower text visibility"] = "Toggle lower text visibility" -- Requires localization
L["Toggle mouseover on/off"] = "Toggle mouseover on/off" -- Requires localization
L["Toggle mouseover on/off for buffs/debuffs"] = "Toggle mouseover on/off for buffs/debuffs" -- Requires localization
L["Toggle mouseover on/off for target"] = "Toggle mouseover on/off for target" -- Requires localization
L["Toggles contextual background coloring"] = "Toggles contextual background coloring" -- Requires localization
L["Toggle spell cast text visibility"] = "Toggle spell cast text visibility" -- Requires localization
...
L["Toggle upper text visibility"] = "Toggle upper text visibility" -- Requires localization
L["Totem cooldown mode"] = "토템 쿨다운 모드" -- Needs review
L["Totem gap"] = "토템 간격" -- Needs review
L["Totem orientation"] = "Totem orientation" -- Requires localization
L["ToT frame texture"] = "ToT frame texture" -- Requires localization
L["Transparency Settings"] = "투명도 설정" -- Needs review
...
L["Unit to track"] = "추적 대상" -- Needs review
L["Update"] = "업데이트" -- Needs review
L["Update Period"] = "업데이트 주기" -- Needs review
L["Upper Text"] = "위쪽 문자" -- Needs review
L["Upper Text Color"] = "위쪽 문자 색상" -- Needs review
L["Upper text visible"] = "위쪽 문자 보이기" -- Needs review
...
L["Use Dog Tags"] = "Use Dog Tags" -- Requires localization
L["Use multiple buff colors"] = "Use multiple buff colors" -- Requires localization
L["Use normal alpha"] = "일반 알파 사용" -- Needs review
L["Uses the 'color bar by mana %' setting/colors even for classes that don't use Mana"] = "Uses the 'color bar by mana %' setting/colors even for classes that don't use Mana" -- Requires localization
...
L["Vertical position"] = "수직 위치" -- Needs review
L["Vertical Position"] = "수직 위치" -- Needs review
L["Visibility Settings"] = "가시성 설정" -- Needs review
L["What alpha value to use for the bar that displays how long your RtB will last if you activate it. (This gets multiplied by the bar's current alpha to stay in line with the bar on top of it)"] = "What alpha value to use for the bar that displays how long your RtB will last if you activate it. (This gets multiplied by the bar's current alpha to stay in line with the bar on top of it)" -- Requires localization
...
L["What alpha value to use for the bar that displays how much effective health you have including absorbs (This gets multiplied by the bar's current alpha to stay in line with the bar on top of it)"] = "What alpha value to use for the bar that displays how much effective health you have including absorbs (This gets multiplied by the bar's current alpha to stay in line with the bar on top of it)" -- Requires localization
...
L["What graphical representation each rune should have. When setting to anything other than 'graphical', the module will behave more like combo points and simply show how many are active."] = "What graphical representation each rune should have. When setting to anything other than 'graphical', the module will behave more like combo points and simply show how many are active." -- Requires localization
...
L["When to display this bar."] = "When to display this bar." -- Requires localization
...
L["Whether or not to display an icon for the aura that this bar is tracking"] = "Whether or not to display an icon for the aura or item that this bar is tracking" -- Requires localization
...
L["Whether or not to display when you have no target selected but have combo points available"] = "Whether or not to display when you have no target selected but have combo points available" -- Requires localization
...
L["Whether or not to show absorb amounts as a lighter-colored bar on top of your current health."] = "Whether or not to show absorb amounts as a lighter-colored bar on top of your current health." -- Requires localization
L["Whether or not to show an IceHUD icon on the minimap."] = "Whether or not to show an IceHUD icon on the minimap." -- Requires localization
...
L["Whether or not to show the default cast bar."] = "Whether or not to show the default cast bar." -- Requires localization
L["Whether or not to show the loot master icon"] = "Whether or not to show the loot master icon" -- Requires localization
...
L["Whether or not to show the Party Role icon"] = "Whether or not to show the Party Role icon" -- Requires localization
L["Whether or not to show the PvP icon"] = "Whether or not to show the PvP icon" -- Requires localization
...
L["Whether to show the Runes module any time the player has fewer than max runes available (regardless of combat/target status)."] = "Whether to show the Runes module any time the player has fewer than max runes available (regardless of combat/target status)." -- Requires localization
L["Whether to show this bar when a spellcast longer than the global cooldown is being cast."] = "Whether to show this bar when a spellcast longer than the global cooldown is being cast." -- Requires localization
...
Some spells, such as Conflagrate, have charges that get consumed and then rebuild. Other spells, such as Focus Fire, have stacks that don't necessarily coincide with a buff/debuff.]=] -- Requires localization
...
L["Which item cooldown this bar will be tracking."] = "Which item cooldown this bar will be tracking." -- Requires localization
...
L["Will only show this bar if the target uses mana (as opposed to rage, energy, runic power, etc.)"] = "대상이 마나를 사용할 경우만 보이기 (분노, 기력, 룬마력 등등은 보이지 않음)" -- Needs review
...
L["You have changed IceHUD profiles while in combat. This can cause problems due to Blizzard's secure frame policy. You may need to reload your UI to repair IceHUD."] = "전투 중에 IceHUD 프로필을 바꿨습니다. 블리자드의 프레임 정책에 의거하여 문제가 발생할 수 있습니다. UI를 재시작하여 IceHUD 설정을 고쳐야할 지도 모릅니다." -- Needs review
