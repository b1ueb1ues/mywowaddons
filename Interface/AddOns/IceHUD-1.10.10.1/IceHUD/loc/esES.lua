...
L["1 combo point: yellow, max combo points: red"] = "1 punto de combo: amarillo, 5 puntos de combo: rojo" -- Needs review
...
L["Adjusts the size of the aura icon for this bar"] = "Ajustar el tamaño del icono de aura para esta barra" -- Needs review
...
L["Advanced Bar Settings"] = "Opciones avanzadas de barra" -- Needs review
L["Aggro Indicator alpha"] = "Indicador de agro alpha" -- Needs review
L["Aggro indicator alpha (0 is disabled)"] = "Indicador de agro alpha (0 es deshabilitado)" -- Needs review
L["Alert Party"] = "Avisar al grupo" -- Needs review
L["Allow click casting"] = "Permitir lanzar hechizos con click" -- Needs review
...
L["Always show at 100% alpha"] = "Mostrar siempre la transparencia al 100%" -- Needs review
L["Animate changes"] = "Animar cambios" -- Needs review
L["Animation Duration"] = "Duración de la Animación" -- Needs review
L["Animation Settings"] = "Ajustes de la Animación" -- Needs review
L["Answers to questions that are frequently asked."] = "Respuestas a las preguntas que se hacen con frecuencia." -- Needs review
...
L["Aura icon horizontal offset"] = "Compensación horizontal del icono de aura" -- Needs review
L["Aura icon scale"] = "Tamaño del icono de aura" -- Needs review
L["Aura icon vertical offset"] = "Compensación vertical del icono de aura" -- Needs review
L["Aura settings"] = "Ajustes de Auras" -- Needs review
L["Aura to track"] = "Aura a rastrear" -- Needs review
...
L["Background alpha for bars OOC without target"] = "Transparencia del fondo para las barras fuera de combate y sin objetivo" -- Needs review
L["Background Color"] = "Color del Fondo" -- Needs review
L["Bar Alpha"] = "Transparencia de Barra" -- Needs review
...
L["Show the tooltip for this unit when the mouse is hovering over it."] = "Muestra el tooltip para esta unidad cuando el cursor está encima de ella." -- Needs review
