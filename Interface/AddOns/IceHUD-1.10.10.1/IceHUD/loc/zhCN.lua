...
L["1 combo point: yellow, max combo points: red"] = "1 连击点:黄色, 5 连击点:红色" -- Needs review
...
L["Adjusts the size of the aura icon for this bar"] = "调整条列的光环图示尺寸" -- Needs review
L["Adjust the horizontal position of the aura icon"] = "调整光环图标的水平位置" -- Needs review
L["Adjust the vertical placement of this bar"] = "调整垂直条列的放置"
L["Adjust the vertical position of the aura icon"] = "调整光环图标的垂直位置" -- Needs review
...
L["Aura icon horizontal offset"] = "光环图示水平位移" -- Needs review
L["Aura icon scale"] = "光环图示刻度" -- Needs review
L["Aura icon vertical offset"] = "光环图示垂直位移" -- Needs review
...
L["Display aura icon"] = "显示光环图标" -- Needs review
L["Display mode"] = "显示模式"
L["Display Mode"] = "显示模式"
...
L["Whether we are tracking a buff or debuff"] = "无论我们追踪增益或减益" -- Needs review
