...
addon.TalentsBySpec = TalentsBfA
addon.Talents = {}
...
function addon.HasActiveTalent(talent)
	...
	-- 11th parameter appears to indicate granted (in this case by legendary) as opposed to chosen.
	local id, name, iconTexture, selected, available, _, _, _, _, active, granted = 
		_G.GetTalentInfoByID(talentId, activeGroup)
	return name and (active or granted)
end
